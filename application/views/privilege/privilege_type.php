  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-uppercase text-sm">privillage type</p>
          <form action="">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="example-text-input" class="form-control-label">privillage type name</label>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="">
                      <p class="text-xs font-weight-bold mb-0">privillage type</p>
                     </td>
