  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-uppercase text-sm">privillage group</p>
          <form action="">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="example-text-input" class="form-control-label">privillage group name</label>
              ...
              <table class="table align-items-center mb-0">
                <thead class="">
                  <tr>
                    ...
                    <th class="text-uppercase text-primary text-xxs font-weight-bolder opacity-7 ">privillage group</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0">privillage group</p>
