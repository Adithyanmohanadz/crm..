  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a data-bs-toggle="collapse" href="#privilege" class="nav-link active" aria-controls="privilege" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
              <i class="ni ni-app text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">privilege</span>
          </a>
          <div class="collapse  show " id="privilege">
                        <ul class="nav ms-4">
                            <li class="nav-item active">
                                <a class="nav-link active" href="<?= base_url() ?>privilege_type">
                                    <span class="sidenav-mini-icon"> T </span>
                                    <span class="sidenav-normal"> Type </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url() ?>privilege_group">
                                    <span class="sidenav-mini-icon"> G </span>
                                    <span class="sidenav-normal"> Group </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url() ?>privilege_grouptype">
                                    <span class="sidenav-mini-icon"> GT </span>
                                    <span class="sidenav-normal"> GroupType </span>
                                </a>
                            </li>
                        </ul>
                    </div>
              ...
              <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <div class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="<?= base_url() ?>assets/img/avatar/user.png" class="avatar avatar-sm  me-3 " alt="user image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                        ...
                        <p class="text-xs text-secondary mb-0">
                          ...
                          <a href="<?= base_url() ?>profile"><button type="button" class="btn btn-secondary btn-sm mb-n1"><i class="fa fa-edit me-2"></i>Edit</button></a>
                        </p>
                      </div>
                    </div>
                  </div>
