            ...
            <form action="">
                <div class="card  p-3 border-radius-xl bg-white" data-animation="FadeIn">
                    <div class="row button-row d-flex mt-n1 mb-3">
                        ...
                        <a href="p-4.html" class="col-4 btn bg-gradient-success ms-auto mb-0 js-btn-next p-3" type="button" title="Submit">Submit</a>
                    </div>
                                    ...
                                    <div class="row justify-content-center my-3 ms-1 pe-md-3">
                                        <div class="col-12">
                                            <div class=" input-group">
                                                ...
                                                <span class="bg-gradient-success input-group-text text-body"><i class="fas fa-search text-white" aria-hidden="true"></i></span>
                                            </div>
                                        </div>
                                        <div class=" mt-4">
                                            <button type="button" class="col-12 btn btn-outline-dark mb-0">Product List</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
