...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('assets/img/GL-img/crm-1336.webp'); background-position: center;">
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body ">
              <form role="form">
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Username or email address" aria-label="Name">
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password">
                </div>
                
                <div class="text-center"> <a href="<?= base_url() ?>dashboard">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign in</button> </a>
                </div>
              </form>
            </div>
          </div>
